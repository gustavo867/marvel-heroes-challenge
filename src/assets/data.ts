...
import SpiderMan1 from "../assets/movies/captain-america-3.jpg";
import SpiderMan2 from "../assets/movies/spider-man-homecoming.jpg";
import SpiderMan3 from "../assets/movies/avengers-3.jpg";
import SpiderMan4 from "../assets/movies/avengers-4.jpg";
import SpiderMan5 from "../assets/movies/spider-man-far-from-home.jpg";

import BlackPanther from "../assets/chars/black-panther.png";
import BlackPanther1 from "../assets/movies/captain-america-3.jpg";
import BlackPanther2 from "../assets/movies/black-panther.jpg";
import BlackPanther3 from "../assets/movies/avengers-3.jpg";
import BlackPanther4 from "../assets/movies/avengers-4.jpg";

import IronMan from "../assets/chars/iron-man.png";
import IronMan1 from "../assets/movies/iron-man-1.jpg";
import IronMan2 from "../assets/movies/iron-man-2.jpg";
import IronMan3 from "../assets/movies/hulk.jpg";
import IronMan4 from "../assets/movies/avengers-1.jpg";
import IronMan5 from "../assets/movies/iron-man-3.jpg";
import IronMan6 from "../assets/movies/avengers-2.jpg";
import IronMan7 from "../assets/movies/captain-america-3.jpg";
import IronMan8 from "../assets/movies/spider-man-homecoming.jpg";
import IronMan9 from "../assets/movies/avengers-3.jpg";
import IronMan10 from "../assets/movies/avengers-4.jpg";

import RedSkull from "../assets/chars/red-skull.png";
import RedSkull1 from "../assets/movies/captain-america-1.jpg";
import RedSkull2 from "../assets/movies/avengers-4.jpg";

import DrDoom from "../assets/chars/dr-doom.png";
import DrDoom1 from "../assets/movies/fantastic-four-1.jpg";
import DrDoom2 from "../assets/movies/fantastic-four-2.jpg";

import GreenGlobin from "../assets/chars/green-goblin.png";
import GreenGlobin1 from "../assets/movies/spider-man-1.jpg";

import Deadpool from "../assets/chars/deadpool.png";
import Deadpool1 from "../assets/movies/deadpool-1.jpg";
import Deadpool2 from "../assets/movies/deadpool-2.jpg";

import Venom from "../assets/chars/venom.png";
import Venom1 from "../assets/movies/venom.jpg";

import Punisher from "../assets/chars/punisher.png";
import Punisher1 from "../assets/movies/punisher.jpg";

import Thanos from "../assets/chars/thanos.png";
import Thanos1 from "../assets/movies/guardians-of-the-galaxy-1.jpg";

import Ronan from "../assets/chars/ronan.png";
import Ronan1 from "../assets/movies/captain-marvel.jpg";

import Talos from "../assets/chars/talos.png";

import HowardStark from "../assets/chars/howard-stark.png";
import HowardStark1 from "../assets/movies/captain-america-2.jpg";
import HowardStark2 from "../assets/movies/ant-man.jpg";

import MaryJane from "../assets/chars/mary-jane.png";
import MaryJane1 from "../assets/movies/spider-man-1.jpg";
import MaryJane2 from "../assets/movies/spider-man-2.jpg";
import MaryJane3 from "../assets/movies/spider-man-3.jpg";

import HappyHogan from "../assets/chars/happy-hogan.png";
...
const Data = {
  heroes: [
    {
      ...
      movies: [SpiderMan1, SpiderMan2, SpiderMan3, SpiderMan4, SpiderMan5],
    },
    {
      name: "Pantera Negra",
      alterEgo: "T'Challa",
      ...
      movies: [BlackPanther1, BlackPanther2, BlackPanther3, BlackPanther4],
    },
    {
      name: "Homem de Ferro",
      alterEgo: "Tony Stark",
  ...
  villains: [
    ...
    },
    {
      ...
      movies: [DrDoom1, DrDoom2],
    },
    {
      name: "Duende Verde",
      alterEgo: "Norman Osborn",
      imagePath: GreenGlobin,
      biography:
  ...
  aliens: [
    {
      ...
      movies: [Thanos1, IronMan9, IronMan10],
    },
    {
      name: "Ronan",
      alterEgo: "Kree",
  ...
  humans: [
    ...
    },
    {
      ...
      movies: [MaryJane1, MaryJane2, MaryJane3],
    },
    {
      name: "Happy Hogan",
      alterEgo: "Homem de Ferro",
      imagePath: HappyHogan,
      biography:
